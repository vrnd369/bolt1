...
function ServiceCard({
  ...
  return (
    <div
      className={`${bgClass} rounded-3xl p-8 hover:scale-[1.02] transition-all duration-300 group`}
    >
      <div className="p-4 rounded-2xl inline-flex items-center justify-center mb-6 shadow-lg">
          ...
          element={
            <React.Fragment>
              <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
                    ...
                    >
                      <div className="w-full max-w-none px-0 py-4 flex justify-between items-center">
                        <div className="flex items-center space-x-0">
                          <Logo />
                          <span className="text-xl md:text-2xl font-bold tracking-tight hover:tracking-wide transition-all duration-300">
                            <span className="text-[#e57701]">Brand</span>
                            <span className="text-[#006457]">Weave</span>
                          </span>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                          <div className="hidden md:flex items-center gap-4">
                            ...
                            <a
                              href="https://twitter.com/BrandWeave"
                              target="_blank"
                              rel="noopener noreferrer"
                              className="p-2 text-white hover:text-[#e57701] transition-colors focus-ring rounded-full"
                            >
                ...
                >
                  <div className="w-full max-w-none px-0">
                    <h2 className="text-3xl sm:text-4xl font-bold text-center mb-6 bg-gradient-to-r from-[#006457] to-[#e57701] text-transparent bg-clip-text">
                      Our Services
                    </h2>
                    <p className="text-gray-600 text-center max-w-2xl mx-auto mb-16 animate-fade-in-delay">
                      Transform your digital presence with our comprehensive
                      suite of professional services designed to elevate your
                      brand and drive growth.
                    </p>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 auto-rows-fr">
                      <ServiceCard
                        icon={
                          <img
                            src="images/Branding & Identity.png"
                        ...
                        bgClass="bg-gradient-to-br from-[#006457] to-[#004036]"
                        platformIcons={
                          <>
                            <div className="flex items-center justify-center">
                              <img
                                src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Adobe_Photoshop_CC_icon.svg/2048px-Adobe_Photoshop_CC_icon.svg.png"
                                alt="Photoshop"
                                className="w-10 h-10 object-contain mx-auto opacity-90 hover:opacity-100 transition-all duration-300 hover:scale-110"
                              />
                            </div>
                            <div className="flex items-center justify-center">
                              <img
                      ...
                      <ServiceCard
                        icon={
                          <img
                            src="images/E-commerce Setup.png"
                            alt="Website Development Icon"
                            className="w-10 h-10 object-contain"
                          />
                        }
                        ...
                        bgClass="bg-gradient-to-br from-[#e57701] to-[#cc6a00]"
                        platformIcons={
                          <>
                            <div className="flex items-center justify-center bg-[#f6f6f7] p-2 rounded-full">
                              <img
                                src="https://cdn.worldvectorlogo.com/logos/shopify.svg"
                                alt="Shopify"
                                className="w-8 h-8 object-contain mx-auto hover:scale-110 transition-all duration-300"
                              />
                            </div>
                            <div className="flex items-center justify-center bg-[#f6f6f7] p-2 rounded-full">
                              <img
                      ...
                      <ServiceCard
                        icon={
                          <img
                            src="images/Performance Marketing.png"
                        ...
                        platformIcons={
                          <>
                            <div className="flex items-center justify-center bg-white/30 p-2 rounded-xl hover:bg-white/40 transition-all duration-300 group">
                              <img
                                src="https://ekommerce360.com/wp-content/uploads/2022/04/Instagram.svg"
                                alt="Instagram"
                                className="w-8 h-8 object-contain mx-auto group-hover:scale-110 transition-transform duration-300"
                              />
                            </div>
                            <div className="flex items-center justify-center bg-white/30 p-2 rounded-xl hover:bg-white/40 transition-all duration-300 group">
                              <img
                            ...
                            <div className="flex items-center justify-center bg-white/30 p-2 rounded-xl hover:bg-white/40 transition-all duration-300 group">
                              <img
                                src="https://ekommerce360.com/wp-content/uploads/2022/05/Meta.svg"
                                alt="Meta"
                                className="w-8 h-8 object-contain mx-auto group-hover:scale-110 transition-transform duration-300"
                              />
                            </div>
                            ...
                            <div className="flex items-center justify-center bg-white/30 p-2 rounded-xl hover:bg-white/40 transition-all duration-300 group">
                              <img
                                src="https://ekommerce360.com/wp-content/uploads/2022/05/Amazon-Ads.svg"
                                alt="Amazon Ads"
                                className="w-8 h-8 object-contain mx-auto group-hover:scale-110 transition-transform duration-300"
                              />
                            </div>
                            <div className="flex items-center justify-center bg-white/30 p-2 rounded-xl hover:bg-white/40 transition-all duration-300 group">
                              <img
                                src="https://ekommerce360.com/wp-content/uploads/2022/04/Analytics.svg"
                            ...
                            <div className="flex items-center justify-center bg-white/30 p-2 rounded-xl hover:bg-white/40 transition-all duration-300 group">
                              <img
                                src="https://ekommerce360.com/wp-content/uploads/2022/05/Google-Shopping-Ads.svg"
                                alt="Google Shopping"
                                className="w-8 h-8 object-contain mx-auto group-hover:scale-110 transition-transform duration-300"
                              />
                            </div>
                            <div className="flex items-center justify-center bg-white/30 p-2 rounded-xl hover:bg-white/40 transition-all duration-300 group">
                              <img
                                src="https://ekommerce360.com/wp-content/uploads/2022/05/Google-Tag-Manager.svg"
                            ...
                            <div className="flex items-center justify-center bg-white/30 p-2 rounded-xl hover:bg-white/40 transition-all duration-300 group">
                              <img
                                src="https://ekommerce360.com/wp-content/uploads/2022/04/Mailchimp-1.svg"
                                alt="Mailchimp"
                                className="w-8 h-8 object-contain mx-auto group-hover:scale-110 transition-transform duration-300"
                              />
                            </div>
                            <div className="flex items-center justify-center bg-white/30 p-2 rounded-xl hover:bg-white/40 transition-all duration-300 group">
                              <img
                                src="https://ekommerce360.com/wp-content/uploads/2022/05/Flipkart-Ads.svg"
                                alt="Flipkart Ads"
                                className="w-8 h-8 object-contain mx-auto group-hover:scale-110 transition-transform duration-300"
                              />
                            </div>
                            <div className="flex items-center justify-center bg-white/30 p-2 rounded-xl hover:bg-white/40 transition-all duration-300 group">
                              <img
                                src="https://ekommerce360.com/wp-content/uploads/2022/05/Google-Business-Profile-copy.svg"
                      ...
                      <ServiceCard
                        icon={
                          <img
                            src="images/Brand Consultation.png"
                            alt="Brand Consultation Icon"
                            className="w-10 h-10 object-contain"
                          />
                        }
                        ...
                        items={[
                          ...
                          "Competitor Mapping",
                          "Technical SEO Audit",
                          "Organic and Paid Social Media Audit",
                        ]}
                        bgClass="bg-gradient-to-br from-[#e57701] to-[#cc6a00]"
                      />
                    </div>
                ...
                <section className="w-full bg-[#004036] py-20">
                  <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                      {/* Facebook */}
                      <a
                        href="https://facebook.com/BrandWeave"
                        target="_blank"
                        rel="noopener noreferrer"
                      ...
                      {/* Instagram */}
                      <a
                        href="https://instagram.com/BrandWeave"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group bg-[#004036] rounded-[2.5rem] border border-white/20 flex items-center p-6 gap-6 hover:border-[#e57701] transition-all duration-300"
                      >
                      ...
                      {/* LinkedIn */}
                      <a
                        href="https://linkedin.com/company/BrandWeave"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group bg-[#004036] rounded-[2.5rem] border border-white/20 flex items-center p-6 gap-6 hover:border-[#e57701] transition-all duration-300"
                      >
                  ...
                  <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                      <div className="flex items-center space-x-0 mb-4 md:mb-0">
                        <Logo />
                        <span className="text-2xl font-bold tracking-tight hover:tracking-wide transition-all duration-300">
                          <span className="text-[#e57701]">Brand</span>
                          <span className="text-[#006457]">Weave</span>
                        </span>
                      </div>
                      <div className="text-gray-400 text-sm">
                        © 2025 BrandWeave. All rights reserved.
                      </div>
                    </div>
                  </div>
                </footer>
